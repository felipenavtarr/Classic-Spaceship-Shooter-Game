...
class Game {
    ...
    endGame () {
        this.ended = true;
        // Si el oponente es de la clase Boss y el jugador sigue vivo, el jugador gana. Si no, pierde.
    ...
    */
    ...
    /**
    * Actualiza en pantalla la puntuación y las vidas
    */
    drawInfo() {
